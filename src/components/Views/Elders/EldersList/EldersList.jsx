    ...
    return (
        <div className='EldersList'>
            <div className="container">
                <div className='row border__styles d-flex align-items-center justify-content-center'>
            ...
            { elders ? 
                (elders.map(elder => {
                    return <div key={elder.id}>
                            <div className='container'>
                                <div className='row border__styles list__row d-flex align-items-center justify-content-center'>
                                    <Link to={`/elders/${elder.id}`} className='col-4 col-md-2 col-lg-3 list__items name__style'>{elder.firstname} {elder.lastname}</Link>
                                    <p className='col-2 d-flex list__items'> <span className={groupColor(elder.group)}>⬤</span></p>
