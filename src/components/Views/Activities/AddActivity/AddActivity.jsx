                ...
                <div className="col-lg- col-md-8 col-sm-10 col-12 border m-5 p-5">
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="row">
                            ...
                            <div className="col">
                                <Form.Group controlId="formBasictitle">    
                                    <Form.Control className={(errors.title) && "is-invalid"} type="date" DefaultValue={activity_id && dataActivity.startDate.split('T')[0].split("-").join("-").toString()} {...register("startDate", { required: true })}/>
