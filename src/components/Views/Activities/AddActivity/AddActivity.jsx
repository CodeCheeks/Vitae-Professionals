                ...
                <div className="col-lg- col-md-8 col-sm-10 col-12 border m-5 p-5">
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="row">
                            ...
                            <div className="col">
                                <Form.Group controlId="formBasictitle">    
                                    <Form.Control className={(errors.title) && "is-invalid"} type="date" defaultValue={activity_id && dataActivity.startDate && dataActivity.startDate.split('T')[0].split("-").join("-")} {...register("startDate", { required: true })}/>
